...
const (
	ErrCodeServerBusyness = -1
	ErrCodeOK             = 0

	ErrCodeInvalidCredential  = 40001 // access_token 过期错误码
	ErrCodeAccessTokenExpired = 42001 // access_token 过期错误码(maybe!!!)

	ErrCodeIllegalDocumentType  = 40002
	ErrCodeIllegalOpenID        = 40003
	ErrCodeInvalidMediaFileType = 40004
	ErrCodeIllegalFileType      = 40005
	ErrCodeInvalidFileSize      = 40006
)

var errDesc = map[int64]string{
	-1:      "系统繁忙",
	0:       "请求成功",
...
var (
	errorType      = reflect.TypeOf(ApiError{})
...
func (err *ApiError) GetErrDesc() string {
